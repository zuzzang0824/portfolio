...
const circleBefore = document.querySelector(".circle::before");
...
dark.addEventListener("click", () => {
  ...
  Wstroke.forEach((Wstroke) => {
    ...
    // img color change
    github.innerHTML =
      '<img src="./images/Wgithub.svg" alt="github" id="github_icon" width="30px">';
    velog.innerHTML =
      '<img src="./images/Wvelog.svg" alt="velog" width="31px">';
    instagram.innerHTML =
      '<img src="./images/Winstagram.svg" alt="instagram" id="instagram_icon" width="30px">';
...
light.addEventListener("click", (e) => {
  ...
  Wstroke.forEach((Wstroke) => {
    ...
    // img color change
    github.innerHTML =
      '<img src="./images/github.svg" alt="github" id="github_icon" width="30px">';
    velog.innerHTML = '<img src="./images/velog.svg" alt="velog" width="31px">';
    instagram.innerHTML =
      '<img src="./images/instagram.svg" alt="instagram" id="instagram_icon" width="30px">';
